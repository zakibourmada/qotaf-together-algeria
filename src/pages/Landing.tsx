  ...
  const features = [
    {
      ...
      descEn:
        "Comprehensive system for collecting and recycling plastic bottles",
    },
    {
      icon: Users,
      ...
      descEn:
        "Network of volunteers and associations working together for the environment",
    },
    {
      icon: Award,
      ...
      descEn:
        "Channeling proceeds to support humanitarian initiatives in Algeria",
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="shadow-card hover:shadow-float transition-all duration-300"
                >
